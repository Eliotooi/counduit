...
export const Button: FC<PropsWithChildren<ButtonProps>> =({
  ...
  const btnClasses = clsx(
    'text-center align-middle curser-pointer select-none border active:bg-conduit-gray-650 hover:bg-conduit-gray-400',
    {
      ...
      'py-1 px-2 text-sm  rounded-buttonSm': 
      size === ButtonSizeEnum.BASE,

      'py-3 px-6 text-xl rounded': 
      size === ButtonSizeEnum.LG,
    }
    )
  return <button className={btnClasses} {...buttonProps}>{children}</button>
}